...
open class EditFilters {
    ...
    fun checkStatusCorrect(value: String): Boolean = value.isNotBlank() && Status.values().any { value == it.value }
    fun checkGenreCorrect(value: String): Boolean = value.isNotBlank() && Genre.values().any { value == it.value }
